...
'''
laserdict = {'405 nm': 'PXI6733/port0/line0',
             '488 nm': 'PXI6733/port0/line1',
             '561 nm': 'PXI6733/port0/line2',
...
# # camera_parameters = {'x_pixels' : 3200,
                     ...
                     # 'gain_index': 1, # Enable HDR mode
                     # 'exp_out_mode': 4,
                     # 'scan_mode' : 0, # Scan mode options: {'Auto': 0, 'Line Delay': 1, 'Scan Width': 2}
                     # 'scan_direction' : 0, # Scan direction options: {'Down': 0, 'Up': 1, 'Down/Up Alternate': 2}
                     # 'scan_line_delay' : 1, # 11.2 us x factor, a factor = 3 equals 33.6 us
                    # }
...
stage_parameters = {'stage_type' : 'TigerASI', # e.g. 'DemoStage', 'PI_1controllerNstages', 'PI_NcontrollersNstages', or 'TigerASI', see above
...
asi_parameters = {'COMport' : 'COM9',
                  ...
                  'stage_assignment': {'x':'X', 'y':'V', 'z':'Z', 'theta':'T', 'f':'Y'},
                  'encoder_conversion': {'V': 10., 'Z': 10., 'R': 100., 'X': 10., 'Y': 10.}, # num of encoder counts per um or degree, depending on stage type.
                  'stage_trigger_source': '/PXI6259/PFI0',
                  'stage_trigger_out_line': '/PXI6259/ctr1',
                  'stage_trigger_delay_%' : 92.5, # Set to 92.5 for stage triggering exactly after the ETL sweep
                  'stage_trigger_pulse_%' : 1,
                  'ttl_motion_enabled': True,
                  'ttl_cards':(2,3),
...
'max_laser_voltage':5,
'intensity' : 50,
'shutterstate':True, # Is the shutter open or not?
'shutterconfig':'left', # Can be "Left", "Right","Both","Interleaved"
'laser_interleaving':True,
